...
\begin{figure}[H]
   \centering
   \includegraphics[width=\textwidth]{06Coding/05Pictures/initial_roadmap.jpg}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.3]{09Evaluation/07Pictures/performanceLighthouse.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[scale=0.6]{09Evaluation/07Pictures/licensingPip.png}
