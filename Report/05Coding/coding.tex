...
\begin{enumerate}
    ...
    \item \textbf{API keys: }We will salt and then hash the API keys with SHA512 before storing them. Since the number of financial data APIs on the market is relatively low, we can use the SHA512 algorithm without worrying about computation time.
