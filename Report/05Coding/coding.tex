...
\subsection{Integration  \& Deployment}
...
Our deployment process is thus fully automized and immune to failing tests, as it will only complete successfully if the application is in a correct state. The full CI/CD workflow is captured by the on \figurename{\ref{CI_CD}}.
