...
\subsubsection{Dash}
\label{Dash}
We decided to use "Dash" as our framework for building our web application. Since Dash is a pure Python framework and some team members were already familiar with it, it was our clear option for building our application. Dash is very good for applications that require data visualisation, modelling, analysis which is precisely what is needed for our portfolio backtesting software.
