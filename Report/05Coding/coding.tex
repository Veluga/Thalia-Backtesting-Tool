...
For the rest of the requirements of the data collection system we have seen that no already existing systems can do what we want. As a result we had to write our own system.
