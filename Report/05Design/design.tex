...
\begin{figure}[H]
	...
	\includegraphics[width=\textwidth]{05Design/04Pictures/architecture_layer_diagram.png}
\end{figure}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=\textwidth]{05Design/04Pictures/dashboard.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=\textwidth]{05Design/04Pictures/portfolio_growth.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=\textwidth]{05Design/04Pictures/wireframe.png}
