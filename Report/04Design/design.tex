...
The purpose of Data Harvester is collecting live data from multiple sources and parse it to a format that makes it usable by Anda and easily storable by our in-house DBMS system Finda. The parts that make the Data Harvester are the Continuous Updating Mechanism, the API Handler, the Data Standardization and Interpolation, the Logging mechanism. Besides the mentioned mentioned Data Harvester components another section on long term maintenance of the assets and APIs will be included.
