...
\begin{itemize}
	...
	\item Between steps 3 and 6, the user may optionally enter a rebalancing frequency and a contribution/withdrawl amount and frequency. The system should take these into account when calculating.
\end{itemize}
