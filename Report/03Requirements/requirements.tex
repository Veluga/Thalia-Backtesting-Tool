...
Earlier in the inception phase of the development, we classified our requirements using the established FURPS+ model \cite{FURPS}, despite its shortcomings \cite{FURPS_drawbacks}, such as not considering portability and maintainability. We believed using this model allowed us to focus on the key aspects of Thalia.
Let us briefly revisit our main functional and non-functional requirements. The items outlined below focus on some of the key requirements we have so far identified as features necessary to provide a compelling product for paying customers.
