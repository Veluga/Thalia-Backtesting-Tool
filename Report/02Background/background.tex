...
\begin{itemize}
\item \textbf{Addriana: }She is an older person that is trying to invest to have a comfortable retirement. She has used the services of a financial advisor but was disappointed with them. As a result, she wants to have more control and a better view of investing to be able to make her own choices.
\item \textbf{Allison: }She is a finance student that wants to use the knowledge she acquired from university.
\item\textbf{Sam: }He is a middle-aged that wishes to try investing to acquire more wealth. 
\item\textbf{Timmy: }Timmy is a young man that is interested in mainly short term investments to make enough money to support himself.
\end{itemize}

With the personas created we conceived a number of scenarios investing scenarios where backtesting was involved. With the scenarios and the personas created we did a few usage simulations that helped us extract the empathy maps of those personas. We then validated our empathy maps with our team and outsiders. The validation with people from outside our team was crucial in eliminating some of our internal biases.
Based on the user personas and their empathy maps we have started looking at what types of metrics are best at describing our personas. The most meaning full ones we have seen are the knowledge on the topic of finance and the number of funds they have available for investing, another metric that was found to be important was that of the types of investing done. Based on those metrics we have identified 4 user types. Here they are enumerated starting from high financial knowledge and large funds available for investing and going to low financial knowledge and small amounts of money that can be invested. In addition, the type of investing they would do is also mentioned.

\begin{enumerate}
    \item \textbf{High Financial Knowledge \& High Investing Funds:  }This person already knows the benefits of backtesting and only needs a tool that can speed up the process of constructing an investment portfolio. The resources they have makes it so that the price of using our product would not be a problem for them. This type of user would do both long and short term investments.
    \item \textbf{High Financial Knowledge \& Low Investing Funds:  }This is most probably someone young that has a keen interest in finance or is studying it. The price could be a deterrent for them to use our product if they are doing short term investing. If they would be doing long term investing however the price did not pose a problem since it could be included in the investment.
    \item \textbf{Low Financial Knowledge \& High Investing Funds:  }This is a person that wants to switch from having a savings account or a financial advisor. They are aware of the learning curve and need additional information before they will commit to anything. They will be happy to pay for our product in order to gain access to our data, analysis and general advice.
    \item \textbf{Low Financial Knowledge \& Low Investing Funds :  }This  last category is represented by people that are not confident in their ability to invest successfully. As a result, they do not want to risk large sums of money until they will be sure that they can make the right decisions. There is a good chance that they will acquire our product to form an idea of what investing is like. If they get more confident they can increase the funds that they want to invest. If the opposite happens then they will most probably quit investing.
\end{enumerate}
