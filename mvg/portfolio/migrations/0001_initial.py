# Generated by Django 2.2.7 on 2019-11-16 12:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('assetclass', models.CharField(choices=[('COMMODITIES', 'Commodities'), ('CRYPTO', 'Cryptocurrency'), ('EQUITIES', 'Equities'), ('FOREX', 'FOREX'), ('FIXED', 'Fixed Income')], max_length=100)),
                ('category', models.CharField(choices=[('Shrimp', 'Shrimp'), ('Tea', 'Tea'), ('Sugar', 'Sugar')], max_length=100)),
