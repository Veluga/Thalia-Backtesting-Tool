...
def db_controller():
    ...
    conn1.close()
    conn2.close()
    return {'seeded':FdMultiController.fd_connect('__seeded_test_db__', 'rwd'),
...
ac = con['seeded'].read.read_asset_classes()
print(ac)
con['empty'].write.write_asset_classes(ac)
print(con['empty'].read.read_asset_classes())
