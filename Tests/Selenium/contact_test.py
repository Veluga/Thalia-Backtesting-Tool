...
def contact_test(driver):
    ...
    email_field = driver.find_element_by_xpath(
        "/html/body/div/section/div/div/div/div[5]/form/div/div[2]/input"
    )
    email_field.send_keys(util.email)

    title_field = driver.find_element_by_xpath(
        "/html/body/div/section/div/div/div/div[5]/form/div/div[3]/input"
    )
    title_field.send_keys(util.title)

    contents_field = driver.find_element_by_xpath(
        "/html/body/div/section/div/div/div/div[5]/form/div/div[4]/textarea"
    )
    contents_field.send_keys(util.contents)

    send_feedback_btn = driver.find_element_by_xpath(
        "/html/body/div/section/div/div/div/div[5]/form/div/div[5]/div/button"
    )
